...
- `CEO_Customer_Report.qmd` / `.html` / `.pdf` — Quarto report for CEO
- `Combined_Risk_Memo_Ian_and_Peter.md`, `Peter_Risk_Flag_Memo.md` — risk memos
- `.rds` files: `city_summary.rds`, `ian_detail.rds`, `peter_detail.rds`, `rep_region.rds`, `rep_summary_export.rds`
- `.png` plots:
  - `Customer_Distribution_by_Location.png`, `Ian_Regional_Spread_Risk.png`, `Peter_Regional_Spread_Risk.png`, `Sales_Rep_Coverage_by_Region.png`
